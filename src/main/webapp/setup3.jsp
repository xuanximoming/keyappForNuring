...
<head>
    ...
    <style type="text/css">
        ...
        #version {float:left;font-size:28px; line-height:60px; margin-left:20px}
        #update { border-top:3px solid #00a9ec}
        #update td {background:#f0f0f0; border-bottom:1px solid #CCC}
        #th td{background:#1e7ca5; color:#FFF}
...
<div>
    <form name="form1" method="post" action="sysconfig.do">
        <table width="100%" border="0" align="center" cellpadding="10" cellspacing="0" id="push_order">
            <tr>
                <td width="18%" align="right">接口串码</td>
                <td width="48%"><input type="text" name="apicode" value="<%=apicode %>"></td>
                <td width="34%">&nbsp;</td>
            </tr>
            <tr>
                <td align="right">APP超时自动退出时长</td>
                <td><input name="apptimeout" type="text" size="10" value="<%=apptimeout %>">
                    秒</td>
                <td>&nbsp;</td>
            </tr>
            <tr>
...
<div>
    <form name="form2" method="post" action="upload.do" enctype="multipart/form-data" >
        <table width="100%" border="0" align="center" cellpadding="10" cellspacing="0" id="update">
            <tr>
